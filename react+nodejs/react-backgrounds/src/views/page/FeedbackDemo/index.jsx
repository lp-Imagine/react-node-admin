...
class FeedbackDemo extends Component {
  ...
  showTypeModal = (type) => {
    Modal[type]({
      title: type,
      content:
        "一些提示内容一些提示内容一些提示内容一些提示内容一些提示内容一些提示内容...",
      maskClosable: true,
    });
  };
  render() {
      ...
      <div style={{ padding: 24 }}>
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <Button
                onClick={() =>
                  this.setState({ drawer: { ...drawer, visible: true } })
                }
              >
                弹出抽屉
              </Button>
              <RadioGroup
                ...
                onChange={(e) =>
                  this.setState({
                    drawer: { ...drawer, placement: e.target.value },
                  })
                }
              >
              ...
              <Drawer
                ...
                closable={false}
                onClose={() =>
                  this.setState({ drawer: { ...drawer, visible: false } })
                }
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              ...
              <Tooltip title="一般通知提醒框">
                <Button onClick={() => this.openNotification("info")}>
                  一般
                </Button>
                &emsp;
              </Tooltip>
              <Tooltip title="警告通知提醒框">
                <Button onClick={() => this.openNotification("warning")}>
                  警告
                </Button>
                &emsp;
              </Tooltip>
              <Tooltip title="失败通知提醒框">
                <Button onClick={() => this.openNotification("error")}>
                  失败
                </Button>
                &emsp;
              </Tooltip>
              <Select
                ...
                onChange={(value) =>
                  this.setState({
                    notification: { ...notification, placement: value },
                  })
                }
              >
          ...
          <Col span={12}>
            ...
            >
              ...
              <Tooltip title="一般信息框">
                <Button onClick={() => this.showTypeModal("info")}>
                  一般信息框
                </Button>
                &emsp;
              </Tooltip>
              <Tooltip title="成功信息框">
                <Button onClick={() => this.showTypeModal("success")}>
                  成功信息框
                </Button>
                &emsp;
              </Tooltip>
              <Tooltip title="错误信息框">
                <Button onClick={() => this.showTypeModal("error")}>
                  错误信息框
                </Button>
                &emsp;
              </Tooltip>
              <Tooltip title="警告信息框">
                <Button
                  onClick={() => this.showTypeModal("warning")}
                  style={{ marginTop: 8 }}
                >
                  警告信息框
                </Button>
        ...
        <Row>
          <RadioGroup
            defaultValue="403"
            onChange={(e) =>
              this.setState({ result: { ...result, type: e.target.value } })
            }
          >
